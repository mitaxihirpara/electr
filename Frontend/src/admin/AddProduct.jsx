...
//   //   return;
//   // }
//   //   if (!form.name || !form.price || !form.category || !form.category_id ||!form.subcategory_id || 
//   //     // !form.brand || 
//   //     !form.stock || !image) {
...
//   //     setForm({ name: "", price: "", category: "", category_id: "", subcategory_id: "", stock: "" });
//   //     setImage(null);
//   //   } catch (err) {
...
//     !form.category_id ||   // Only send category_id to backend
//     !form.subcategory_id ||
//     !form.brand ||
//     !form.stock ||
//     !image
...
//     // Try to parse JSON, catch parsing error
//     let result;
//     try {
...
//         </div>
//         <div className="form-group">
//           <label>Category (For Sub Category)</label>
//               <select
...
const AddProduct = () => {
  ...
  const handleSubmit = async (e) => {
   ...
   console.log("Image:", image);
    ...
    // Validation
    if (!form.name || !form.price || !form.category_id || !form.subcategory_id || !form.brand || !form.stock || !image) {
      alert("Please fill all fields");
      return;
    }
